enchant.ui = { assets: ['images/rpg/pad.png', 'images/rpg/apad.png'] };
enchant.ui.Pad = enchant.Class.create(enchant.Sprite, {
    initialize: function() {
        var game = enchant.Game.instance;
        var image = game.assets['images/rpg/pad.png'];
        enchant.Sprite.call(this, image.width / 2, image.height);
        this.image = image;
        this.input = { left: false, right: false, up: false, down:false };
        /**
        * Adding in Keyboard imputs
        */
        if (document.addEventListener){
		    document.addEventListener("keydown",catchKeyDown(this),false);
		    document.addEventListener("keyup",catchKeyUp(this),false);
		}  // end if
		else if (document.attachEvent){
		    document.attachEvent("onkeydown",catchKeyDown(this));
		    document.attachEvent("onkeyup",catchKeyUp(this));
		} // end else if
...
enchant.ui.APad = enchant.Class.create(enchant.Group, {
  initialize: function(mode) {
        var game = enchant.Game.instance;
        var image = game.assets['images/rpg/apad.png'];
