var actualLevel = 0,
			 ...
			 var game = new mibbu(GAME_WIDTH, GAME_HEIGHT );
				...
				var tlo = new game.background( IMAGE_DIR + 'backgrounds/'+LEVELS[actualLevel].background, SCROLL_SPEED, "S"); //sprite file, speed, direction (N, S, W, E)
				tlo.start();
				...
				board.src = IMAGE_DIR + "boards/" + LEVELS[actualLevel].board; 
